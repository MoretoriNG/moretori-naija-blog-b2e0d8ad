...
import { Sparkles, Shield, Users, ArrowLeft, BookOpen, Download } from 'lucide-react';
...
export default function UserAuthPage() {
  ...
  const handleRegister = async (email: string, password: string, userData: any) => {
    // Add user role to metadata
    const userDataWithRole = {
      ...userData,
      role: 'user'
    };
    await signUp(email, password, userDataWithRole);
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url('https://images.unsplash.com/photo-1481627834876-b7833e8f5570?q=80&w=1974&auto=format&fit=crop')`,
